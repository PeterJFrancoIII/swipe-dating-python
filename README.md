# Swipe Dating — Bot-Control Python R&D

A local, synthetic-only Python web app for testing one focused flow: exact 18+ gating,
discovery, community-powered bot review, and reciprocal matching. The broader domain models remain
available for research, but the active UI intentionally exposes only this small vertical slice.
