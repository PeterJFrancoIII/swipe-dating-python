...
ALLOWED_TABS: Final = frozenset(
    {"Discover", "My Profile", "Preferences", "Skin Shop", "Matched Map"}
)
...
def sanitize_local_state(value: object) -> LocalState:
    ...
    return LocalState(
        ...
        ui=LocalUi(
            ...
            last_tab=(str(ui["lastTab"]) if ui.get("lastTab") in ALLOWED_TABS else "Discover"),
        ),
    )
